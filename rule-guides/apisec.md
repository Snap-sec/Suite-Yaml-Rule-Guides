...
All specified fields are evaluated together. If all match conditions return `true`, the rule is considered a match.
...
Matches if any header value contains `application/json`.
